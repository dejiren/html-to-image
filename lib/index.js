...
function toSvg(node, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var _b, width, height, clonedNode, datauri;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _b = (0, util_1.getImageSize)(node, options), width = _b.width, height = _b.height;
...
function toCanvas(node, options) {
    ...
    if (options === void 0) { options = {}; }
    return __awaiter(this, void 0, void 0, function () {
        var _b, width, height, svg, img, canvas, context, ratio, canvasWidth, canvasHeight;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    // Check for abort signal at the beginning
                ...
                case 1:
                    svg = _c.sent();
                    return [4 /*yield*/, (0, util_1.createImage)(svg, options.signal)];
                case 2:
                    img = _c.sent();
...
function toPixelData(node, options) {
    ...
    if (options === void 0) { options = {}; }
    return __awaiter(this, void 0, void 0, function () {
        var _b, width, height, canvas, ctx;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    // Check for abort signal at the beginning
