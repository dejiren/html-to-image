                    ...
                    try {
                        (0, util_1.toArray)(sheet.cssRules || []).forEach(function (item, index) {
                            if (item.type === CSSRule.IMPORT_RULE) {
                                ...
                                var url = item.href;
                                var deferred = fetchCSS(url, options.signal)
                        ...
                        if (sheet.href != null) {
                            deferreds.push(fetchCSS(sheet.href, options.signal)
                                .then(function (metadata) { return embedFonts(metadata, options); })
                                .then(function (cssText) {
                                return parseCSS(cssText).forEach(function (rule) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all(rules
                            ...
                            return __generator(this, function (_b) {
                                ...
                                baseUrl = rule.parentStyleSheet
                                    ? rule.parentStyleSheet.href
                                    : null;
                                return [2 /*return*/, (0, embed_resources_1.embedResources)(rule.cssText, baseUrl, options)];
                            });
                        }); }))];
                case 2:
                    cssTexts = _b.sent();
...
function embedWebFonts(clonedNode, options) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var cssText, _b, _c, styleNode, sytleContent;
